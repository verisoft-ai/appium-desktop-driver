    ...
    if (Object.values(OrientationTypeProperty).includes(property as OrientationTypeProperty)) {
      try {
        ...
        if (
          ...
          log.debug(
            `OrientationType assertion failed for AutomationHeadingLevel.NONE (${e instanceof Error ? e.message : e}), coercing to OrientationType.NONE.`,
          );
          ...
          log.debug(
            `OrientationType assertion failed (${e instanceof Error ? e.message : e}), accepting raw Int32 value ${value.toString()}.`,
          );
        }
      }
    }
    ...
    if (Object.values(AutomationHeadingLevelProperty).includes(property as AutomationHeadingLevelProperty)) {
      try {
        ...
        if (value instanceof PSOrientationType && value.originalValue.toLowerCase() === OrientationType.NONE) {
          log.debug(
            `AutomationHeadingLevel assertion failed for OrientationType.NONE (${e instanceof Error ? e.message : e}), coercing to AutomationHeadingLevel.NONE.`,
          );
          ...
          log.debug(
            `AutomationHeadingLevel assertion failed (${e instanceof Error ? e.message : e}), accepting raw Int32 value ${value.toString()}.`,
          );
        }
      }
    }
